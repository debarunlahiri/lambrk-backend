...
public class FileWatcherProperties {
  ...
  public boolean isEmitSpringEvents() {
    return emitSpringEvents;
  }

  public void setEmitSpringEvents(boolean emitSpringEvents) {
    this.emitSpringEvents = emitSpringEvents;
  }
}
