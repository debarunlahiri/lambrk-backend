...
public class FileUploadController {
  ...
  public ResponseEntity<List<FileUploadResponse>> uploadFile(
    ...
    if (files == null || files.isEmpty()) {
      throw new IllegalArgumentException(
          "No files provided. Attach files using the 'files' form field.");
    }
  ...
  public ResponseEntity<FileUploadResponse> getFileMetadata(
      @PathVariable @SpanTag UUID fileId, @AuthenticationPrincipal UserPrincipal userDetails) {
  ...
  public ResponseEntity<Page<FileUploadResponse>> getPublicFiles(
    ...
    Pageable pageable = PageRequest.of(page, size);
    Page<FileUploadResponse> files =
        fileUploadService.getFilesByType(FileUploadRequest.FileType.POST_IMAGE, pageable);
    return ResponseEntity.ok(files);
  }
  ...
  public ResponseEntity<Object> getFileStats(@AuthenticationPrincipal UserPrincipal userDetails) {
