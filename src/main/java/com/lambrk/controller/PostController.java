...
public class PostController {
  ...
  public ResponseEntity<PostResponse> getPost(
      @PathVariable @SpanTag UUID postId, @AuthenticationPrincipal UserPrincipal userDetails) {
  ...
  public ResponseEntity<Page<PostResponse>> getPostsByCommunity(
    ...
    Page<PostResponse> response =
        postService.getPostsByCommunity(communityId, pageable, currentUserId);
    return ResponseEntity.ok(response);
  }
  ...
  @Counted(
      value = "posts.media.fetched",
      extraTags = {"type", "loopmix"})
  public ResponseEntity<Page<PostResponse>> getMediaPosts(
    ...
    switch (type.toUpperCase()) {
      case "IMAGE" ->
          mediaTypes =
              new com.lambrk.domain.Post.PostType[] {com.lambrk.domain.Post.PostType.IMAGE};
      case "VIDEO" ->
          mediaTypes =
              new com.lambrk.domain.Post.PostType[] {com.lambrk.domain.Post.PostType.VIDEO};
      default ->
          mediaTypes =
              new com.lambrk.domain.Post.PostType[] {
                com.lambrk.domain.Post.PostType.IMAGE, com.lambrk.domain.Post.PostType.VIDEO
              };
    }
    ...
    UUID currentUserId = getUserIdFromUserDetails(userDetails);
    Page<PostResponse> response =
        postService.getMediaPosts(List.of(mediaTypes), pageable, currentUserId);
    return ResponseEntity.ok(response);
  }
