...
public class CategoryController {
  ...
  public ResponseEntity<CategoryResponse> getCategory(@PathVariable @SpanTag UUID categoryId) {
  ...
  public ResponseEntity<CategoryResponse> getCategoryBySlug(@PathVariable @SpanTag String slug) {
  ...
  public ResponseEntity<CategoryResponse> updateCategory(
      @PathVariable @SpanTag UUID categoryId, @Valid @RequestBody CategoryCreateRequest request) {
  ...
  @PreAuthorize("hasRole('ADMIN')")
  public ResponseEntity<Void> deleteCategory(@PathVariable @SpanTag UUID categoryId) {
