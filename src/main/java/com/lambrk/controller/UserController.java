...
public class UserController {
  ...
  public ResponseEntity<SocialUserResponse> getUser(
      @PathVariable @SpanTag UUID userId, @AuthenticationPrincipal UserPrincipal userPrincipal) {
    User user =
        userRepository
            .findById(userId)
            .orElseThrow(() -> new ResourceNotFoundException("User", "id", userId));
    return ResponseEntity.ok(
        userSocialService.toSocialUserResponse(user, getUserId(userPrincipal)));
  }
  ...
  public ResponseEntity<Page<SocialUserResponse>> getTopUsers(
    ...
    return ResponseEntity.ok(
        userRepository
            .findTopUsersByKarma(pageable)
            .map(user -> userSocialService.toSocialUserResponse(user, getUserId(userPrincipal))));
  }

  @GetMapping("/search")
  @NewSpan("search-users")
  @Timed(value = "users.search.duration")
  public ResponseEntity<Page<SocialUserResponse>> searchUsers(
    ...
    return ResponseEntity.ok(
        userRepository
            .searchActiveUsers(query, pageable)
            .map(user -> userSocialService.toSocialUserResponse(user, getUserId(userPrincipal))));
  }
  ...
  public ResponseEntity<Page<SocialUserResponse>> getFollowers(
    ...
    return ResponseEntity.ok(
        userSocialService.getFollowers(userId, getUserId(userPrincipal), pageable));
  }
  ...
  public ResponseEntity<Page<SocialUserResponse>> getFollowing(
    ...
    Pageable pageable = PageRequest.of(page, size, Sort.by(Sort.Direction.DESC, "createdAt"));
    return ResponseEntity.ok(
        userSocialService.getFollowing(userId, getUserId(userPrincipal), pageable));
  }
  ...
  public ResponseEntity<Page<SocialUserResponse>> getFriends(
    ...
    Pageable pageable = PageRequest.of(page, size);
    return ResponseEntity.ok(
        userSocialService.getFriends(userId, getUserId(userPrincipal), pageable));
  }
  ...
  public ResponseEntity<Page<SocialUserResponse>> getMutualFollowers(
    ...
    Pageable pageable = PageRequest.of(page, size);
    return ResponseEntity.ok(
        userSocialService.getMutualFollowers(
            userId, comparisonUserId, getUserId(userPrincipal), pageable));
  }
  ...
  public ResponseEntity<Page<SocialUserResponse>> getMutualFollowing(
    ...
    Pageable pageable = PageRequest.of(page, size);
    return ResponseEntity.ok(
        userSocialService.getMutualFollowing(
            userId, comparisonUserId, getUserId(userPrincipal), pageable));
  }
  ...
  public ResponseEntity<Page<SocialUserResponse>> getMutualFriends(
    ...
    Pageable pageable = PageRequest.of(page, size);
    return ResponseEntity.ok(
        userSocialService.getMutualFriends(
            userId, comparisonUserId, getUserId(userPrincipal), pageable));
  }
  ...
  public ResponseEntity<Page<FriendRequestResponse>> getIncomingFriendRequests(
    ...
    Pageable pageable = PageRequest.of(page, size);
    return ResponseEntity.ok(
        userSocialService.getIncomingFriendRequests(userPrincipal.getUserId(), pageable));
  }
  ...
  public ResponseEntity<Page<FriendRequestResponse>> getOutgoingFriendRequests(
    ...
    Pageable pageable = PageRequest.of(page, size);
    return ResponseEntity.ok(
        userSocialService.getOutgoingFriendRequests(userPrincipal.getUserId(), pageable));
  }
