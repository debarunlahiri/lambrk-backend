...
public class CommunityController {
  ...
  public ResponseEntity<CommunityResponse> getCommunity(
      @PathVariable @SpanTag UUID communityId, @AuthenticationPrincipal UserPrincipal userDetails) {
  ...
  public ResponseEntity<CommunityResponse> getCommunityByName(
      @PathVariable @SpanTag String name, @AuthenticationPrincipal UserPrincipal userDetails) {
  ...
  public ResponseEntity<CommunityResponse> updateCommunity(
    ...
    return ResponseEntity.ok(
        communityService.updateCommunity(communityId, request, getUserId(userDetails)));
  }
