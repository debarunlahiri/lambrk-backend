...
public class SearchController {
  ...
  public ResponseEntity<SearchResponse> advancedSearch(
    ...
    SearchResponse response = searchService.search(request, getUserId(userDetails));
  ...
  public ResponseEntity<List<String>> getSearchSuggestions(
      @RequestParam @SpanTag String query, @RequestParam(defaultValue = "posts") String type) {
    ...
    List<String> suggestions =
        switch (type) {
          ...
          case "users" -> List.of(query + "user", query + "dev", query + "official");
          default -> List.of();
        };
