...
public class Notification {
    ...
    public Notification(UUID id, NotificationType type, User recipient, String title, String message,
    ...
    public Notification(NotificationType type, User recipient, String title, String message,
                        ...
                        String actionUrl, String actionText, boolean isRead, Instant createdAt,
                        Instant updatedAt, Instant readAt) {
        this(com.lambrk.util.UuidV7Generator.generate(), type, recipient, title, message, relatedPostId, relatedCommentId, relatedUserId,
    ...
    public enum NotificationType {
        ...
        USER_FOLLOW, FRIEND_REQUEST, FRIEND_REQUEST_ACCEPTED
    }
    ...
    public UUID getRelatedCommentId() { return relatedCommentId; }
    public void setRelatedCommentId(UUID relatedCommentId) { this.relatedCommentId = relatedCommentId; }
