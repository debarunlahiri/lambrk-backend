...
public class FileUpload {
    ...
    public FileUpload(UUID id, String fileName, String originalFileName, String fileUrl, String thumbnailUrl,
                      FileUploadType type, long fileSize, String mimeType, String description,
                      boolean isPublic, boolean isNSFW, String altText, User uploadedBy,
                      Instant uploadedAt, Instant updatedAt, String checksum) {
        this.id = id;
    ...
    public FileUpload(FileUploadType type, String fileName, String originalFileName,
        ...
        this(com.lambrk.util.UuidV7Generator.generate(), fileName, originalFileName, fileUrl, thumbnailUrl, type, fileSize, mimeType,
    ...
    public FileUploadType getType() { return type; }
    public void setType(FileUploadType type) { this.type = type; }
    ...
    public void setNSFW(boolean nsfw) { this.isNSFW = nsfw; }
