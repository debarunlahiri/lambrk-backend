...
public class User {
  ...
  public boolean isHideFollowerCount() {
    return hideFollowerCount;
  }

  public void setHideFollowerCount(boolean hideFollowerCount) {
    this.hideFollowerCount = hideFollowerCount;
  }

  public boolean isHideFollowingCount() {
    return hideFollowingCount;
  }

  public void setHideFollowingCount(boolean hideFollowingCount) {
    this.hideFollowingCount = hideFollowingCount;
  }

  public boolean isHideFollowerList() {
    return hideFollowerList;
  }

  public void setHideFollowerList(boolean hideFollowerList) {
    this.hideFollowerList = hideFollowerList;
  }

  public boolean isHideFollowingList() {
    return hideFollowingList;
  }

  public void setHideFollowingList(boolean hideFollowingList) {
    this.hideFollowingList = hideFollowingList;
  }

  public boolean isHideAddFriendButton() {
    return hideAddFriendButton;
  }

  public void setHideAddFriendButton(boolean hideAddFriendButton) {
    this.hideAddFriendButton = hideAddFriendButton;
  }

  public boolean isHideFollowButton() {
    return hideFollowButton;
  }

  public void setHideFollowButton(boolean hideFollowButton) {
    this.hideFollowButton = hideFollowButton;
  }

  public boolean isHideFromMutualList() {
    return hideFromMutualList;
  }

  public void setHideFromMutualList(boolean hideFromMutualList) {
    this.hideFromMutualList = hideFromMutualList;
  }

  public boolean isMessageButtonEnabled() {
    return messageButtonEnabled;
  }

  public void setMessageButtonEnabled(boolean messageButtonEnabled) {
    this.messageButtonEnabled = messageButtonEnabled;
  }
  ...
  public Set<UserCommunityMembership> getMemberships() {
    return memberships;
  }

  public void setMemberships(Set<UserCommunityMembership> memberships) {
    this.memberships = memberships;
  }

  public Set<UserCommunityModerator> getModeratorRoles() {
    return moderatorRoles;
  }

  public void setModeratorRoles(Set<UserCommunityModerator> moderatorRoles) {
