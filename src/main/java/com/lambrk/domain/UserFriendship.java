...
@Entity
@Table(name = "user_friendships", indexes = {
    ...
    @Index(name = "idx_user_friendship_pair", columnList = "user_one_id, user_two_id", unique = true)
})
...
public class UserFriendship {
    ...
    public UserFriendship(UUID id, User userOne, User userTwo, User requester, User addressee,
                          String source, String requestMessage) {
        this.id = id;
    ...
    public User getLastActionUser() { return lastActionUser; }
