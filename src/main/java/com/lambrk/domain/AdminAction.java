...
public class AdminAction {
    ...
    public AdminAction(UUID id, AdminActionType type, UUID targetId, String targetType, String reason,
    ...
    public AdminAction(AdminActionType type, UUID targetId, String targetType, String reason,
                       String notes, UUID performedBy, Instant createdAt, Instant expiresAt,
                       boolean isActive, String result) {
        this(com.lambrk.util.UuidV7Generator.generate(), type, targetId, targetType, reason, notes, performedBy, createdAt, expiresAt, isActive, result);
    }
