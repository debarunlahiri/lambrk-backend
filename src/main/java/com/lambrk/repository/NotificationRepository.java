...
public interface NotificationRepository extends JpaRepository<Notification, UUID> {
  ...
  @Query(
      "SELECT n FROM Notification n WHERE n.recipient.id = :userId AND n.isRead = :isRead ORDER BY"
          + " n.createdAt DESC")
  ...
  @Query(
      "SELECT n FROM Notification n WHERE n.recipient.id = :userId AND n.type = :type ORDER BY"
          + " n.createdAt DESC")
