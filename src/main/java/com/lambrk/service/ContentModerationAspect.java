...
public class ContentModerationAspect {
  ...
  public ContentModerationAspect(
      AIContentModerationService moderationService, MeterRegistry meterRegistry, Tracer tracer) {
  ...
  public Object moderateContent(ProceedingJoinPoint joinPoint) throws Throwable {
    ...
    if (content != null && contentType != null) {
      ...
      // Record metrics
      meterRegistry.counter("content.moderation.attempts", "type", contentType).increment();
      ...
      if (!result.approved()) {
        ...
        throw new ContentModerationException(
            "Content rejected: " + result.reason(), result.categories());
      }

      meterRegistry.counter("content.moderation.approved", "type", contentType).increment();
    }
