...
public class NativeImageConfig {
  ...
  static class LambrkRuntimeHintsRegistrar
    ...
    public void registerHints(RuntimeHints hints, ClassLoader classLoader) {
      ...
      hints
          .reflection()
          .registerType(
              TypeReference.of("org.springframework.data.redis.connection.RedisConnectionFactory"))
      ...
      hints
          .reflection()
          .registerType(
              TypeReference.of("com.lambrk.repository.UserRepository"),
              MemberCategory.INVOKE_DECLARED_METHODS)
          .registerType(
              TypeReference.of("com.lambrk.repository.PostRepository"),
              MemberCategory.INVOKE_DECLARED_METHODS)
          .registerType(
              TypeReference.of("com.lambrk.repository.CommentRepository"),
              MemberCategory.INVOKE_DECLARED_METHODS)
          .registerType(
              TypeReference.of("com.lambrk.repository.CommunityRepository"),
              MemberCategory.INVOKE_DECLARED_METHODS)
          .registerType(
              TypeReference.of("com.lambrk.repository.VoteRepository"),
              MemberCategory.INVOKE_DECLARED_METHODS);
